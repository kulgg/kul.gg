...
export default function ProjectEntry({ project }: { project: Project }) {
  return (
    <div className="p-6 max-w-sm rounded-lg h-48 border shadow-md bg-slate-800 border-gray-500 hover:border-gray-300 hover:scale-[1.05] transition duration-100 group flex flex-col justify-between">
      <div>
